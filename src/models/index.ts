...
import {
  ...
  ResetPasswordTokenInstance,
} from "./interfaces/reset_password_token";
import {
  RolePermissionAttributes,
  RolePermissionInstance,
} from "./interfaces/role_permission";
...
_models.User.hasMany(_models.ResetPasswordToken, {
  as: "reset_password_tokens",
  onDelete: "CASCADE",
});
_models.Role.belongsToMany(_models.User, {
  through: _models.UserRole,
  as: "Permissions",
  onDelete: "CASCADE",
  individualHooks: true,
});
_models.User.belongsToMany(_models.Role, {
  through: _models.UserRole,
  as: "roles",
  onDelete: "CASCADE",
  individualHooks: true,
});
_models.Role.belongsToMany(_models.Permission, {
  through: _models.RolePermission,
  as: "permission",
  onDelete: "CASCADE",
  individualHooks: true,
});
_models.Permission.belongsToMany(_models.Role, {
  through: _models.RolePermission,
  as: "roles",
  onDelete: "CASCADE",
  individualHooks: true,
